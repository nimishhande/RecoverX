...
export function seedData() {
  ...
  const hour = (h) => h * 60; // convert hours to minutes

  // --- Project 1: E-Commerce Redesign (Profitable) ---
  const p1 = {
    id: uuidv4(),
    name: 'E-Commerce Redesign',
    clientName: 'TechMart India',
    projectType: 'fixed',
    fixedPrice: 120000,
    hourlyRate: null,
    estimatedHours: 80,
  ...
  // --- Project 2: Mobile App MVP (Risky — scope creep) ---
  const p2 = {
    id: uuidv4(),
    name: 'Mobile App MVP',
  ...
  // --- Project 3: Brand Identity (Loss-making — too many revisions) ---
  const p3 = {
    id: uuidv4(),
    name: 'Brand Identity Package',
    clientName: 'Café Bloom',
    projectType: 'fixed',
    fixedPrice: 35000,
    hourlyRate: null,
    estimatedHours: 25,
  ...
  // --- Project 4: API Integration (Hourly — healthy) ---
  const p4 = {
    id: uuidv4(),
    name: 'API Integration Suite',
    clientName: 'FinServ Corp',
    projectType: 'hourly',
    fixedPrice: null,
    hourlyRate: 1200,
    estimatedHours: 40,
  ...
  // --- Project 5: Dashboard Analytics (Completed — good) ---
  const p5 = {
    id: uuidv4(),
    name: 'Dashboard Analytics Tool',
    clientName: 'DataView Inc',
    projectType: 'fixed',
    fixedPrice: 95000,
    hourlyRate: null,
    estimatedHours: 60,
  ...
  store.timelogs = [
    ...
    log(p2.id, 'scope', 12, hour(8), 'Client requested chat feature (not in scope)'),
    ...
    // P3 — Brand Identity (revision heavy — loss-making)
    ...
    // P4 — API Integration (hourly, healthy)
    ...
    // P5 — Dashboard Analytics (completed, good)
  ...
  console.log(`📦 Seeded ${store.projects.length} projects and ${store.timelogs.length} time logs`);
}
